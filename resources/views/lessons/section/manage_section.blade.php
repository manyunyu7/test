            ...
            <nav aria-label="breadcrumb">
              ...
              @endphp
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('lesson.show', $lesson->id) }}">{{$lesson->course_title}}</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-12">
                                <div class="nav flex-column nav-pills nav-secondary nav-pills-no-bd nav-pills-icons"
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary btn-border btn-round mb-3">Submit</button>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group row d-none">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{$lesson->course_title}}" @error('course_name') is-invalid
                ...
                <tbody>
                        ...
                        <div class="modal-dialog modal-fullscreen">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('section.update', [$data->section_id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                              <div class="box-body">
                                    <div>
                                        <video loop controls width="100%"  class="video-mask">
                                            <source src="{{ Storage::url("public/class/content/".$data->lesson_id."/".$data->section_video)}}"
                                            type=video/mp4>
                                        </video>
                                    </div>
                                    <div class="form-group">
                                        <label>Judul Materi</label> 
                                        <input type="text" class="form-control" name="section_u_title" placeholder="User ID" value="{{$data->section_title}}">
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <input accept=".mp4,video/*" id="input-video" type="file"
                                        onchange="previewVideo()"
                                        class="form-control @error('video') is-invalid @enderror"
                                        value="{{ old('section_u_video') }}" name="section_u_video">
                                        <small id="helpId" class="form-text text-muted">Kosongkan Jika Video Tidak Ingin Diganti</small> 
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control"  name="section_u_order" placeholder="Enter username" value="{{$realSectionOrder}}">
                                        <small id="helpId" class="form-text text-muted">Urutan Materi dengan angka sama hanya boleh ada 1 di kelas yang sama</small> 
                                    </div>
                    ...
                    <tr>
                       ...
                       {{-- START OF MODAL FOR VIDEO --}}
                        <div class="modal fade  bd-example-modal-xl" id="video-modal{{$loop->iteration}}">
                                ...
                                <div class="modal-body">
                                  <div class="box-body">
                                        <div>
                                            ...
                                            <video loop controls width="100%"  class="video-mask">
                                                <source src="{{ Storage::url("public/class/content/".$data->lesson_id."/".$data->section_video."?random1")}}"
                                                type=video/mp4>
                                            </video>
                                            <br><hr>
                    ...
                    {{-- Start OF Table Data --}}
                        ...
                        <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit-modal{{$loop->iteration}}">
                            Lihat/Edit Detail
                          </button>
                          </td>
                        <td>
                            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#video-modal{{$loop->iteration}}">Lihat Video</button>
                        </td>
                        <td class="text-center">
                            <form id="delete-post-form" action="{{ route('section.destroy', [$data->section_id])}}" method="POST">
                                @csrf
                                @method('DELETE')
