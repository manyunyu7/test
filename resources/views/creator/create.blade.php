            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters mb-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        <span class="text-uppercase page-subtitle">Tambah Kreator Website (Tim)</span>
                        <h3 class="page-title">Tambah Kreator</h3>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input id="inputTitle" type="text"
                                           ...
                                           value="{{ old('name') }}" placeholder="Masukkan Nama ANGGOTA Tim">
                            ...
                            <div class="col-md-12">
                                <div class="card border-0 shadow rounded">
                                    <div class="card-body">
                                        ...
                                        @csrf
                                        <div class="form-group">
                                            <label class="font-weight-bold">GAMBAR Foto</label>
