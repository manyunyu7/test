    ...
    <div class="mt-5 px-4">
          ...
          <div class="page-header row no-gutters py-4">
            ...
            <div class="col-12 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Anggota Tim</span>
                <h3 class="page-title">Anggota Tim {{config('app.name')}}</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <tbody>
                              @forelse ($datas as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->name }}</td>
                                    <td class="text-center">
                                        <img src="{{ asset($data->photo) }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td class="text-center">
                                        {{$data->role}}
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <form id="delete-post-form" action="{{ route('creator.destroy', $data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <td>
                                        <a href="{{ route('creator.edit',$data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                    </td>
                                </tr>
                              @empty
